<script setup lang="ts">
  ...
  const tools: iLinkCard[] = [
    { icon: 'mdi-jira', title: 'Jira', description: 'Project and issue tracking', link: 'https://fdm4inc.atlassian.net/' },
    { icon: '/icons/tempo.svg', title: 'Tempo', description: 'Time tracking', link: 'https://fdm4inc.atlassian.net/plugins/servlet/ac/io.tempo.jira/tempo-app' },
    { icon: '/icons/fdm4.png', title: 'FDM4 Project Control Center', description: 'Project management', link: 'https://fdm4dev2.fdm4.com/control/' },
    { icon: 'mdi-bitbucket', title: 'BitBucket', description: 'Code source control', link: 'https://bitbucket.org/fdm4inc/workspace/overview/' },
    { icon: 'mdi-assistant', title: 'FDM4 Assistant', description: 'Assistant tool', link: '' },
    ...
    { icon: 'mdi-palm-tree', title: 'Softtime', description: 'Vacation and personal time booking', link: 'https://portal.softtimeonline2.com/sto/index.html' },
    { icon: 'mdi-alarm-check', title: 'Mitre Finch', description: 'Punch Card service', link: 'https://tms2019.fdm4.com/TMS/tms/login?ReturnUrl=%2fTMS%2fDashboard%2fDashboardHome%2fIndex%3fcs%3d8510794&cs=8510794' },
  ];

  const docs: iLinkCard[] = [
    { icon: '/icons/confluence.svg', title: 'Confluence', description: 'Team collaboration', link: 'https://fdm4inc.atlassian.net/wiki/home' },
    ...
    { icon: '/icons/scribe.png', title: 'Scribe', description: 'Documentation tool', link: 'https://scribehow.com/workspace#dashboard' },
    { icon: '/icons/onedrive.svg', title: 'Onedrive', description: 'File storage', link: 'https://fdm4int-my.sharepoint.com/' }
  ];

  const news: iLinkCard[] = [
    { icon: 'mdi-information', title: '"Company News"', description: 'Relevant news for all employees will display here periodically once integrated.', link: 'https://fdm4inc.atlassian.net/wiki/home' },
  ];
