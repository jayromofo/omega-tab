        ...
        <div v-if="isCSQuery || fuzzyResults.length || (getFilteredHistory.length && searchQuery)"
          ...
          <div v-if="isCSQuery">
            ...
            <div class="dropdown-item">
              <div>FDM4 Control page Links</div>
...
<script setup lang="ts">
  ...
  const jiraLink = computed(() => `https://fdm4inc.atlassian.net/browse/${searchQuery.value}`);

  const confluenceLink = computed(() => `https://fdm4inc.atlassian.net/wiki/search?text="${searchQuery.value}"`);
